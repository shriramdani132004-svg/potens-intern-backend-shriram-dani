...
A production-oriented backend system for immutable and tamper-evident audit logging using SHA-256 cryptographic hash chaining.
...
```bash
git clone https://github.com/shriramdani132004-svg/potens-intern-backend-shriram-dani.git
```
...
```env
DATABASE_URL="postgresql://postgres:SHRIRAM%40shriram@localhost:5432/audit_log_db"
